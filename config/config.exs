...
config :hider, HiderWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [view: HiderWeb.ErrorView, accepts: ~w(html json), layout: false],
  pubsub_server: Hider.PubSub,
  live_view: [signing_salt: "b3ZlCcQ2"]
...
config :hider, Hider.Mailer, adapter: Swoosh.Adapters.Local
